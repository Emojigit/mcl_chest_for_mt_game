...
minetest.register_node("mcl_chests:"..basename, {
	...
	on_rightclick = function(pos, node, clicker)
		...
		"size[9,8.75]"..
		"label[0,0;"..minetest.formspec_escape(minetest.colorize("#fff", S("Chest"))).."]"..
...
minetest.register_node("mcl_chests:"..basename.."_left", {
	...
	on_rightclick = function(pos, node, clicker)
		...
		"mcl_chests:"..canonical_basename.."_"..pos.x.."_"..pos.y.."_"..pos.z,
		"size[9,11.5]"..
		"label[0,0;"..minetest.formspec_escape(minetest.colorize("#fff", S("Large Chest"))).."]"..
		"list[nodemeta:"..pos.x..","..pos.y..","..pos.z..";main;0,0.5;9,3;]"..
		default.get_hotbar_bg(0,0.5,9,3)..
...
register_chest("chest",
	...
	{
		small = {"mcl_chest_top.png", "mcl_chests_chest_bottom.png",
		"mcl_chests_chest_right.png", "mcl_chests_chest_left.png",
		"mcl_chests_chest_back.png", "mcl_chest_front.png"},
		left = {"mcl_chest_top_big.png", "mcl_chest_top_big.png",
		"mcl_chests_chest_right.png", "mcl_chests_chest_left.png",
		"mcl_chest_side_big.png^[transformFX", "mcl_chest_front_big.png"},
		right = {"mcl_chest_top_big.png^[transformFX", "mcl_chest_top_big.png^[transformFX",
		"mcl_chests_chest_right.png", "mcl_chests_chest_left.png",
		"mcl_chest_side_big.png", "mcl_chest_front_big.png^[transformFX"},
	},
	false
)
...
local formspec_ender_chest = "size[9,8.75]"..
	"label[0,0;"..minetest.formspec_escape(minetest.colorize("#fff", S("Ender Chest"))).."]"..
...
local formspec_shulker_box = "size[9,8.75]"..
	"label[0,0;"..minetest.formspec_escape(minetest.colorize("#fff", S("Shulker Box"))).."]"..
